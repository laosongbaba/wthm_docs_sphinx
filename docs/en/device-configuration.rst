...
Once the device is connected to the Wi-Fi network, the next step is to configure its operational parameters. This chapter describes how to use the configuration tool to set up device-specific settings, such as device name, working mode, and cloud service binding.

1. Configuration Tool Overview
------------------------------

You can download the configuration tool for all our devices, along with the software manual, from:
